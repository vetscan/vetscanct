...
export async function generateMetadata({ params }) {
  ...
  const translations = {
    uk: {
      ...
      description: 'КТ тварин у Дніпрі: комп\'ютерна томографія собак та котів на сучасному ветеринарному томографі у VETSCAN CT. КТ Хребта, голови, грудної клітки, суглобів.',
